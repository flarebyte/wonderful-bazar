 ...
 */
public class BasicInterpreterStringBuilder implements IStringBuilder {
	 ...
	 */
	public BasicInterpreterStringBuilder(String script, IStringTransformer[] IStringTransformer) {
		super();
		this.script = script;
	}
