  ...
  ctx =
    req:
      params:
        ...
        edition: "gbr"
  ctx_value =
    about: "http://localhost:3000/flarebyte-marketplace/id/offering/offering8"
...
exports.webpageify_valid_webpage_field_should_populate_additional_fields = (test) ->
  ...
  expected =
    ...
    label: "offering 8 or any good alternative."
    label__slug: "offering-8-or-any-good-alternative."
    about__view_page: 'http://localhost:3010/gbr/offers/offering-8-or-any-good-alternative./offering8'
    about__edit_page: 'https://localhost:3040/gbr/offers/offering-8-or-any-good-alternative./offering8'
...
exports.webpageify_unknown_label_field_should_still_populate_additional_fields = (test) ->
  ...
  ctx_value =
    about: "http://localhost:3000/flarebyte-marketplace/id/offering/offering8"
    label: "offering 8 or any good alternative."
  result = transformer.webpageify(ctx, ctx_value,"about","unknown_label")
  expected =
    about: "http://localhost:3000/flarebyte-marketplace/id/offering/offering8"
    label: "offering 8 or any good alternative."
    about__view_page: 'http://localhost:3010/gbr/offers/offering8'
    about__edit_page: 'https://localhost:3040/gbr/offers/offering8'
...
exports.typify_valid_camelcase_type_field_should_populate_additional_fields = (test) ->
  ctx_value = {type: "http://localhost:3000/flarebyte-marketplace/schema/types#OfferingStuff"}
  result = transformer.typify(ctx_value,"type")
  expected =
    type: "http://localhost:3000/flarebyte-marketplace/schema/types#OfferingStuff"
...
exports.typify_valid_dashcase_type_field_should_populate_additional_fields = (test) ->
  ctx_value = {type: "http://localhost:3000/flarebyte-marketplace/schema/types#Offering-Stuff_more"}
  result = transformer.typify(ctx_value,"type")
  expected =
    type: "http://localhost:3000/flarebyte-marketplace/schema/types#Offering-Stuff_more"
