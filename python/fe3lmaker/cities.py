...
import sys
import os
# Based on the richest cities
cities=["tokyo","newyork","losangeles","chicago","paris","london","osaka","mexico","philadelphia","washingtondc","boston","dallas", "buenosaires","hongkong",
...
city_boroughs={
"london":("cityOfLondon","cityOfWestminster","kensington","chelsea","hammersmith","fulham","wandsworth","lambeth","southwark","towerHamlets","hackney","islington",
"camden","brent","ealing","hounslow","richmond","kingston","merton","sutton","croydon","bromley","lewisham","greenwich","bexley","havering","barking","dagenham",
"redbridge","newham","walthamForest","haringey","enfield","barnet","harrow","hillingdon")
}
...
for borough in city_boroughs:
	locations.extend(city_boroughs[borough])
