...
__date__ ="$Oct 6, 2009 9:25:20 PM$"

if __name__ == "__main__":
    print "Hello World";

class CloudFileField(models.FileField):
    def __init__(self, verbose_name=None, name=None, bucket='', **kwargs):
        models.FileField.__init__(self, verbose_name, name, upload_to="cloud", **kwargs)
        self.bucket = bucket
